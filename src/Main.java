        ...
        while (numPassos != 64) {
            ...
            do{
                ...
                if ((opcoes[0] + casaAtual[0]) < 7 && ((opcoes[1] + casaAtual[0]) > 0)
                    ...
                    opcoesDeMovimento[j][i] = opcoes[0] + casaAtual[0];

                    System.out.println("opcao linha: " + opcoesDeMovimento[j][i]);

                    opcoesDeMovimento[j+1][i] = opcoes[1] + casaAtual[1];

                    System.out.println("opcao coluna: " + opcoesDeMovimento[j][i]);
                } else {
                    movimentosErrados()
                }
                i++;
